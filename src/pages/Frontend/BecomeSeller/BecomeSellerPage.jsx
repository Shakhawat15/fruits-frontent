      ...
      <div className="min-h-screen bg-gray-50 py-16 px-4">
        <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-md p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">
            Thank you for your interest in becoming a seller. Your application is under review.
            We'll contact you within 3-5 business days via email.
          </p>
          <div className="flex justify-center space-x-4">
            <a href="/" className="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-6 rounded-lg transition">
              Back to Home
            </a>
            <a href="/seller-dashboard" className="bg-white hover:bg-gray-100 text-green-600 font-bold py-2 px-6 rounded-lg border border-green-600 transition">
              Seller Dashboard
            </a>
          </div>
        </div>
      ...
      <div className="max-w-4xl mx-auto">
          ...
          <div className="flex justify-between mb-2">
            {[1, 2, 3].map(step => (
              <div key={step} className="text-center">
                <div className={`w-10 h-10 rounded-full flex items-center justify-center mx-auto mb-2 ${currentStep >= step ? 'bg-green-600 text-white' : 'bg-gray-200 text-gray-600'}`}>
                  {step}
                </div>
                <span className={`text-sm ${currentStep >= step ? 'font-medium text-green-600' : 'text-gray-500'}`}>
                  {step === 1 ? 'Business Info' : step === 2 ? 'Product Details' : 'Documents'}
                </span>
              </div>
            ))}
          </div>
        ...
        <div className="flex items-center mb-8">
          ...
          <div>
            ...
            <p className="text-gray-600">Join our marketplace to sell your seasonal fruits directly to customers</p>
          </div>
        </div>

        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-md p-6 md:p-10">
          ...
          {currentStep === 1 && (
            <div className="space-y-6">
              ...
              <div>
                <label htmlFor="yearsInBusiness" className="block text-gray-700 font-medium mb-2">
          ...
          {currentStep === 2 && (
            <div className="space-y-6">
              ...
              <div>
                <label htmlFor="fruitTypes" className="block text-gray-700 font-medium mb-2">
                  Types of Fruits You Sell <span className="text-red-500">*</span>
                </label>
                <select
                  id="fruitTypes"
                  name="fruitTypes"
              ...
              <div>
                <label htmlFor="businessDesc" className="block text-gray-700 font-medium mb-2">
          ...
          {currentStep === 3 && (
            <div className="space-y-6">
              <h2 className="text-2xl font-semibold mb-6">Documents & Agreement</h2>
              ...
              <div>
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                  ...
                  <p className="text-gray-500 mb-1">Drag and drop files here or</p>
                  <input
                    type="file"
                    id="documents"
                    multiple
                ...
                <p className="text-xs text-gray-500 mt-2">
                  Upload business license, certification documents, and product photos (Max 10MB each)
                </p>
              </div>
              ...
              <div className="mt-6">
                <div className="flex items-start">
                  ...
                  <label htmlFor="terms" className="text-sm text-gray-600">
                    ...
                    <a href="#" className="text-green-600 hover:underline">Seller Agreement</a>.
                    I understand that my application will be reviewed and approval is subject to verification.
                  </label>
                </div>
              </div>
